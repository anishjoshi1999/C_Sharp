...
builder.Services.AddDbContext<DataContext>(options =>
    options.UseSqlServer("Server=CGNPLAP433;Database=MinimalApi;User Id=ajsql;Password=123456789;Integrated Security=False;MultipleActiveResultSets=true;TrustServerCertificate=true", sqlServerOptions =>
    {
...
app.MapPut("/Student/{id}", async (DataContext context, Student item,int id) =>
{
    ...
    studentitem.FirstName = item.LastName; 
    studentitem.LastName = item.FirstName;  
